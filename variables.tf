...
variable "redis_multi_az_enabled" {
  ...
  validation {
    condition     = var.tfe_operational_mode == "active-active" && var.redis_multi_az_enabled ? var.redis_automatic_failover_enabled == true && length(var.redis_subnet_ids) > 1 : true
